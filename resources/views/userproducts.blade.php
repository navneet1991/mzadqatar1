...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                   <p>اهلا : <strong><?php if(!emptyArray($sessions)) echo $sessions['phone'] ?></strong></p>
            ...
            <div>
                <div  class="col-md-3 col-sm-6 col-xs-12">
                    <div class="box margin-t-10">
                        ...
                        <div class="box-inner">
                            <h3 class="color-purple margin-0 padding-0">عازل حماية بوليش</h3>
                            <hr class="margin-t-15 margin-b-10">
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <h6 class="margin-t-1 f-size-15 color-dark-grey">500 ر.ق</h6>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-4 brdr-right2">
                                    <h6 class="margin-t-1 f-size-15 color-dark-grey txt-space">44 <img src="assets/images/message_icon.jpg" class="pull-left icon-space" alt="message"></h6>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-4 brdr-right">
                                    <h6 class="margin-t-1 f-size-15 color-dark-grey">44 <img src="assets/images/like_icon.jpg" class="icon-space pull-left" alt="like"></h6>
                                </div>
                            </div>
